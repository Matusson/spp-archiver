...
This plugin allows you to find all spp files in a directory (and its subdirectories) and automatically re-bake all mesh maps at 2x2 resolution. Optionally, it can also delete all autosave files and reduce texture set resolutions, as the resulting sets are also saved in the SPP file. These functions can particularly help you in archiving old files.
...
Latest tested version is v12.0.2.

## Contributing
Feel free to submit a PR if you think there's possible improvements.
